    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none font-sans">
              ...
              <AnimatePresence initial={false}>
                {messages.map((msg) => {
                  ...
                  return (
                    <motion.div
                      key={msg.id}
                      initial={shouldReduceMotion ? { opacity: 0 } : { opacity: 0, x: isUser ? 40 : -40 }}
                    ...
                    >
                      <div className={cn(
                        ...
                        <div className={cn(
                          ...
                          isUser ? 'bg-indigo-100 border-indigo-200' : 'bg-white border-slate-200'
                        )}>
                          {isUser
      ...
      <div className="relative">
        ...
        {!isOpen && !shouldReduceMotion && (
          <>
            <motion.div
              className="absolute inset-0 rounded-full bg-violet-500 pointer-events-none"

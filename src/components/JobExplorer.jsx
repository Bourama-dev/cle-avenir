...
import { Search, MapPin, AlertCircle, Plus, Key, Building2, Briefcase } from 'lucide-react';
...
const JobExplorer = ({ onNavigate }) => {
  ...
  // Company search (only active when companies tab is open and location is set)
  const {

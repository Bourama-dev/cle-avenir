          ...
          <section id="collecte" className="scroll-mt-20">
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-4">
              {[
                ...
                <AnimatedItem key={g.cat}>
                  <div className="p-5 bg-white/[0.03] border border-white/[0.06] rounded-2xl hover:border-violet-500/30 transition-all">
          ...
          <section id="utilisation" className="scroll-mt-20">
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <AnimatedItem key={i}>
                  <div className="flex gap-5 p-5 bg-white/[0.03] border border-white/[0.06] rounded-2xl hover:border-indigo-500/30 transition-all group">
          ...
          <section id="protection" className="scroll-mt-20">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-4">
              {[
                ...
                <AnimatedItem key={i}>
                  <div className="p-5 bg-white/[0.03] border border-white/[0.06] rounded-2xl hover:border-cyan-500/30 transition-all">
          ...
          <section id="droits" className="scroll-mt-20">
            ...
            <div className="mt-8 space-y-3">
              {[
                ...
                <AnimatedItem key={i}>
                  <div className="flex items-center justify-between p-4 bg-white/[0.03] border border-white/[0.06] rounded-xl hover:border-teal-500/30 transition-all group">

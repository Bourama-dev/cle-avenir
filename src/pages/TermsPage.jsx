      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-24">
          ...
          <section id="acces" className="scroll-mt-20">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-4">
              {[{emoji:'🎂',title:'Age minimum 13 ans',desc:'Vous devez avoir au moins 13 ans pour creer un compte.'},{emoji:'✉️',title:'Email valide',desc:'Un email valide est requis pour la verification de compte.'},{emoji:'🔐',title:'Mot de passe fort',desc:'8 caracteres minimum avec majuscule et chiffre.'}].map((item,i) => (
                <AnimatedItem key={i}>
                  <div className="p-5 bg-white/[0.03] border border-white/[0.06] rounded-2xl text-center">
        ...
        <AnimatedSection>
          <section id="propriete" className="scroll-mt-20">
            ...
            <AnimatedItem>
              <p className="mt-8 text-slate-400">L ensemble des elements CleAvenir (algorithmes, design, textes, logos, BDD metiers) est protege par le droit de la propriete intellectuelle.</p>
            </AnimatedItem>
        ...
        <AnimatedSection>
          <section id="modifications" className="scroll-mt-20">
            ...
            <AnimatedItem>
              <p className="mt-8 text-slate-400">CleAvenir peut modifier ces CGU a tout moment. Modifications substantielles notifiees par email avec 30 jours de preavis.</p>
            </AnimatedItem>
            <AnimatedItem>
            ...
            <AnimatedItem>
              <div className="flex gap-3 p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl mt-4">
                <span>ℹ️</span>

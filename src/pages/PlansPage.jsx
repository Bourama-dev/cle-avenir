  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <main className="container mx-auto px-4 py-16 max-w-6xl flex-grow">
        ...
        <AnimatedSection>
          <AnimatedItem>
            <div className="text-center mb-16">
              <TextReveal
                text="Choisissez votre niveau d'accompagnement"
                as="h1"
        ...
        <AnimatedSection className="grid md:grid-cols-3 gap-8 items-start mb-24">

          {/* 1. FREEMIUM - Découverte */}
          <AnimatedItem>
            <TiltCard className="border border-slate-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden h-full">
          ...
          {/* 2. PREMIUM - Clarté */}
          <AnimatedItem>
            <TiltCard className={`border border-violet-200 shadow-lg scale-105 z-10 relative bg-white h-full ${currentTier === TIERS.PREMIUM ? 'ring-2 ring-violet-500' : ''}`}>
              <Card className="border-0 shadow-none h-full flex flex-col">
          ...
          {/* 3. PREMIUM+ - Sécurité */}
          <AnimatedItem>
            <TiltCard className={`border border-yellow-200 shadow-sm hover:shadow-md transition-shadow relative bg-yellow-50/30 h-full ${currentTier === TIERS.PREMIUM_PLUS ? 'ring-2 ring-yellow-500' : ''}`}>

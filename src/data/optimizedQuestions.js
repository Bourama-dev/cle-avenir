...
export const optimizedQuestions = [
  ...
  {
    id: 'sectors', category: 'SECTOR', emoji: '🎯',
    text: "Dans quels secteurs professionnels vous projetez-vous ? (Sélectionnez au moins 1)",
    description: "Choisissez les secteurs qui vous attirent",
    type: 'multi_choice',
    minAnswers: 1,
    maxAnswers: 3,
    isSectorQuestion: true,
    options: [
      { id: 's_tech', text: 'Technologie & Digital', value: 'technology' },
      { id: 's_sci', text: 'Sciences & Recherche', value: 'sciences' },
      { id: 's_health', text: 'Santé & Médical', value: 'health' },
      { id: 's_commerce', text: 'Commerce & Marketing', value: 'commerce' },
      { id: 's_arts', text: 'Arts & Design', value: 'arts' },
      { id: 's_edu', text: 'Éducation & Formation', value: 'education' },
      { id: 's_industry', text: 'Industrie & BTP', value: 'industry' },
      { id: 's_law', text: 'Droit & Justice', value: 'law' },
      { id: 's_sport', text: 'Sport & Loisirs', value: 'sport' },
      { id: 's_events', text: 'Événementiel & Spectacle', value: 'events' },
      { id: 's_env', text: 'Environnement & Écologie', value: 'environment' },
      { id: 's_tourism', text: 'Tourisme & Hôtellerie', value: 'tourism' },
    ],
  },
